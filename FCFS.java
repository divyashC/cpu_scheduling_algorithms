...
public class FCFS {
    ...
    public static void main(String[] args) {
        ...
        // Printing total_p and burst time table
        System.out.println("-------------------------");
		System.out.println("| P No. | AT\t| BT\t|");
		System.out.println("-------------------------");
		for (int i = 0; i < total_p; i++) {
			System.out.println("| P" + pNo[i] + "    | " + at[i] + "\t| " + bt[i] + "\t|");
		}
        System.out.println("-------------------------");
        ...
        for (int i = 0; i < total_p; i++) {
            ...
            System.out.println("| P" + pNo[i] + "    | " + at[i] + "\t| " + bt[i] + "\t| " + ct[i] + "\t| " + tat[i] + "\t| " + wt[i] + "\t|");
